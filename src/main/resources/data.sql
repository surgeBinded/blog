...
-- Insert Comments
INSERT INTO comment (article_id, parent_comment_id, content, likes, dislikes, deleted, date_created, user_id) VALUES
    (1, NULL, 'This is a comment on the first article', 0, 0, false, CURRENT_TIMESTAMP, 1);

INSERT INTO comment (article_id, parent_comment_id, content, likes, dislikes, deleted, date_created, user_id) VALUES
    (1, 1, 'This is a subcomment on the first comment', 0, 0, false, CURRENT_TIMESTAMP, 2);
