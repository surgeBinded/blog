...
INSERT INTO article (title, content, banner_image_url, date_created, user_id) VALUES
    ('First Article', 'This is the content of the first article', 'example.com/image1.jpg', CURRENT_TIMESTAMP, 1);

INSERT INTO article (title, content, banner_image_url, date_created, user_id) VALUES
    ('Second Article', 'This is the content of the second article', 'example.com/image2.jpg', CURRENT_TIMESTAMP, 2);
